...
$HSTREAMING -mapper $MAPPER -file $MAPPER -reducer $REDUCER -file $REDUCER -input './input/hiphopdance/2014*/*' -output ./output2/hiphop2014 -jobconf "PATH=$PATH:/home/hduser/.rvm"
