...
$HSTREAMING -mapper yMapR.rb -file yMapR.rb -reducer yRed.rb -file yRed.rb -input './input/hiphopdance/2014*/*' -output ./hiphopR2014 -jobconf "PATH=$PATH:/home/hduser/.rvm"
