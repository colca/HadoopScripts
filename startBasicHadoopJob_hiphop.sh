...
$HSTREAMING -mapper $MAPPER -file $MAPPER -reducer $REDUCER -file $REDUCER -input './input/hiphopdance/2014-1*/*' -output ./output1/hiphop2014 -jobconf "PATH=$PATH:/home/hduser/.rvm"
